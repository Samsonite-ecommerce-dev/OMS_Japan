...
{
    public class RequireDelivery : IModule
    {
        //初始化标记
        bool isInit = false;
        //停止执行标记
        ...
        {
            baseModel = OAB.InitBase<RequireDelivery>();
        }
        ...
        public void Init()
        {
            ...
            {
                //读取配置
                serviceConfig = OAB.InitService<RequireDelivery>();
        ...
        /// </summary>
        /// <returns></returns>
        private string RequireTrackingNo()
        {
            List<string> _msg = new List<string>();
            FileLogHelper.WriteLog($"Start to require Tracking No. from platform.", baseModel.ThreadName);
