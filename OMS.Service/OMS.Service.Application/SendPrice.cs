...
{
    public class SendPrice : ECommerceBaseService, IModule
    {
        //初始化标记
        bool isInit = false;
        //停止执行标记
        ...
        public SendPrice()
        {
            baseModel = OAB.InitBase<SendPrice>();
        }
        ...
        public void Init()
        {
            ...
            {
                //读取配置
                serviceConfig = OAB.InitService<SendPrice>();
        ...
        /// </summary>
        /// <returns></returns>
        private string SendPriceMessage()
        {
            List<string> _msg = new List<string>();
            FileLogHelper.WriteLog($"Start to send Price to platform.", baseModel.ThreadName);
