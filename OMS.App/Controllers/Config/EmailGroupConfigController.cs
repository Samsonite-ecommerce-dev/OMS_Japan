    ...
    public class EmailGroupConfigController : BaseController
    {
        ...
        public JsonResult Index_Message()
        {
            ...
            using (var db = new DynamicRepository())
            {
                ...
                //查询
                var _list = db.GetPage<SendMailGroup>("select * from SendMailGroup order by id asc", _SqlWhere, VariableHelper.SaferequestInt(Request.Form["rows"]), VariableHelper.SaferequestInt(Request.Form["page"]));
                _result.Data = new
                {
