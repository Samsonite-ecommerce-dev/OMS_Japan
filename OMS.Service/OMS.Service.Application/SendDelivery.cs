...
{
    public class SendDelivery : IModule
    {
        //初始化标记
        bool isInit = false;
        //停止执行标记
        ...
        public SendDelivery()
        {
            baseModel = OAB.InitBase<SendDelivery>();
        }
        ...
        public void Init()
        {
            ...
            {
                //读取配置
                serviceConfig = OAB.InitService<SendDelivery>();
        ...
        private string SendTrackingNo()
        {
            ...
            FileLogHelper.WriteLog($"Start to send Tracking No. to platform.", baseModel.ThreadName);
